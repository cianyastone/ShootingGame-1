...
C2DSprite::C2DSprite(vec2 position)
{
	_iNumVtx = QUAD_NUM;
	_pPoints = NULL; _pNormals = NULL; _pTex = NULL;
...
void C2DSprite::update()
{
	_position = addVector2(_position, _velocity);
}

vec2 C2DSprite::addVector2(vec2 v1, vec2 v2) {
	int x1 = v1.x;
	int x2 = v2.x;
	int y1 = v1.y;
	int y2 = v2.y;
...
void C2DSprite::setRotation(GLfloat rotation)
{
	_rotation = rotation;
}

GLfloat C2DSprite::getRotaion()
{
	return _rotation;
}

void C2DSprite::setPosition(vec2 newPosition)
{
	_position = newPosition;
}

vec2 C2DSprite::getPosition()
{
	return _position;
}

void C2DSprite::setVelocity(vec2 newVector)
{
	_velocity = newVector;
}

vec2 C2DSprite::getVelocity()
{
	return _velocity;
}
